...
**
** Created: Wed Jun 15 13:42:18 2011
...
static const char qt_meta_stringdata_GLObject[] = {
    "GLObject\0\0valueChanged()\0angle\0"
    "setXRotation(int)\0refreshTranslations()\0"
};
...
int GLObject::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: setXRotation((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: refreshTranslations(); break;
        default: ;
        }
        _id -= 3;
    }
